...
trainX, trainY = load_fotos(directory_src="C:\\Users\\Artur\\Desktop\\reconhecimento_facial_arthur\\validacao_faces\\")
...
df['target'] = trainY
print(df.shape)
df.to_csv('validacao_faces.csv', index_label=True)
